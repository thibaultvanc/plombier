...
<div class="services">
		<div class="row service-items wow fadeInUp">
			<div class="col-md-4 text-center">
				<div>
					<a href="<?php echo $shelley_services_href_button_1; ?>"><img style="height: 95px; width:95px" src="<?php echo $shelley_services_image_1; ?>" ></a>
				</div>
			...
			<div class="col-md-4 text-center">
				<div>
					<a href="<?php echo $shelley_services_href_button_2; ?>"><img style="height: 95px; width:95px" src="<?php echo $shelley_services_image_2; ?>" ></a>
				</div>
			...
			<div class="col-md-4 text-center">
				<div>
					<a href="<?php echo $shelley_services_href_button_; ?>"><img style="height: 95px; width:95px" src="<?php echo $shelley_services_image_3; ?>" ></a>
				</div>
